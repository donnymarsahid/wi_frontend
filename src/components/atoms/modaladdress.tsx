...
const ModalAddress = ({
  ...
  return (
    <>
      ...
      >
        <Modal.Header
          className={`${cx(poppins, poppins.className)} bg-white border-b-1`}
        >
          <div>
            <h1 className="text-black">Edit Alamat</h1>
          </div>
        </Modal.Header>
        <Modal.Body className={`${cx(poppins, poppins.className)} bg-white`}>
                ...
                <div className="mb-6">
                  ...
                  <Autosuggest
                    ...
                    onSuggestionsFetchRequested={
                      onSuggestionsFetchRequestedProvince
                    }
                    onSuggestionsClearRequested={
                      onSuggestionsClearRequestedProvince
                    }
                  ...
                  <div className="mt-4 border-l-2 border-gray-300">
                    ...
                    {isCity ? (
                      <>
                        ...
                        <div className="mt-4 flex items-center">
                          <div className="ms-[-7px]  text-lg text-gray-300">
                            ●
                          </div>
                    ...
                    {!isDetailAlamat && (
                      <div className="bg-gray-100 p-2">
                        <h1 className="text-gray-400">
                          Pilih{" "}
                          {isCity ? "Kota" : isSubdistrict ? "Kecamatan" : ""}{" "}
                          Anda
                        </h1>
                      </div>
                    )}
