            ...
            <div className="bg-white">
              ...
              >
                ...
                {item.attributes.discount ? (
                  <>
                    <div className="shadow-lg flex flex-col items-center justify-center bg-gradient-to-r from-[#FF0000] to-red-700 rounded-md md:px-4 md:py-2 text-white border-[1px] border-white p-1">
