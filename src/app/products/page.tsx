...
export default async function Products({ searchParams }: ProductsPageProps) {
  const products: ProductsProps = await getData({
    ...
    params: {
      ...
      "filters[$or][0][wallpaper_by_colors][slug][$eq]": searchParams.styleFilter,
      "filters[$or][1][wallpaper_by_designers][slug][$eq]": searchParams.styleFilter,
      "filters[$or][2][wallpaper_by_styles][slug][$eq]": searchParams.styleFilter,
